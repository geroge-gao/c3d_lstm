...
def c3d_clstm(inputs, num_classes, reuse, is_training):
    ...
    with tf.device('/gpu:0'):
        with tf.variable_scope('C3D_ConvLSTM', reuse=reuse):
            ...
            # drop1 = tl.layers.DropoutLayer(prev_layer=convlstm2,
            #                                keep=0.5,
            #                                name="drop1")
            # fc1 = tl.layers.DenseLayer(prev_layer=convlstm2,
            #                            n_units=800,
            #                            act=tf.nn.relu,
            #                            name="fc1")
            # drop2 = tl.layers.DropoutLayer(prev_layer=fc1,
            #                                keep=0.5,
            #                                name="drop2")
